...
int main()
{
    ...
    Mahasiswa mhs2("3228xxxxxxxx99", "Asep", 'L', "Universitas Padjajaran", "asep@unpad.edu",
                   "19273720", "FPEB", "Bisnis Digital");

    Mahasiswa mhs3("3299xxxxxxxx70", "Bunga", 'P', "Universitas Parahyangan", "bunga@unpar.edu",
                   "212293619", "FH", "Hukum");

    Mahasiswa mhs4("00000007", "FPLIV", "Teknik Fix Gol");
